      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="card mb-4 beginner-card">
            <div class="card-body">
              <h3 class="card-title mb-4">7 Days-beginnerJourney</h3>
              ...
              <div class="tab-content" id="dayTabsContent">
                ...
                <div class="tab-pane fade show active" id="monday" role="tabpanel">
                  <h4>Foundations of beginner yoga</h4>
                  ...
                  <div class="class-details">
                    ...
                    <ul>
                      <li><span class="beginner-highlight">jumping jacks:</span> maintain breathing and pace</li>
                      <li><span class="beginner-highlight">squats:</span> Stretch your hamstrings</li>
                      <li><span class="beginner-highlight">pushup</span> upper body strength</li>
                      <li><span class="beginner-highlight">standing jacks:</span> slow and fun</li>
                    </ul>
                    <button class="btn beginner-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="tuesday" role="tabpanel">
                  ...
                  <div class="class-details">
                    <h5>Today's Practice</h5>
                    <ul>
                      <li><span class="beginner-highlight">pushups</span> maintain breathing</li>
                      <li><span class="beginner-highlight">leg raise:</span> flexible your legs</li>
                      <li><span class="beginner-highlight">glute bridge:</span> Opens the hips</li>
                      <li><span class="beginner-highlight">Simple movements:</span> to rest it out</li>
                    </ul>
                    <button class="btn beginner-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="friday" role="tabpanel">
                  ...
                  <div class="class-details">
                    <h5>Today's Practice</h5>
                    <ul>
                      <li><span class="beginner-highlight">abs crunch:</span> Spinal flexibility</li>
                      <li><span class="beginner-highlight">mountain climber:</span> Deep hamstring stretch</li>
                      <li><span class="beginner">leg raise:</span> Spinal release</li>
                      <li><span class="beginner">standing crunch:</span> Hip and lower back release</li>
                    </ul>
                    <button class="btn beginner-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="saturday" role="tabpanel">
                  ...
                  <div class="class-details">
                    <h5>Today's Practice</h5>
                    <ul>
                      <li><span class="beginner">toe touch:</span> 5 rounds to build heat</li>
                      <li><span class="beginner">Warrior Sequence:</span> Strength building</li>
                      <li><span class="beginner">cat camel:</span> Energizing full body</li>
                      <li><span class="beginner">Cool Down :</span> Gentle stretches</li>
                    </ul>
                    <button class="btn beginner-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="sunday" role="tabpanel">
                  ...
                  <div class="class-details">
                    <h5>Today's Practice</h5>
                    <ul>
                      <li><span class="beginner-highlight">waist circles:</span> 5-minute fun</li>
                      <li><span class="beginner-highlight">neck stretch:</span> Release tension</li>
                      <li><span class="beginner-highlight">side raise:</span> improves side body functionality</li>
                      <li><span class="beginner-highlight">Closing workout:</span> Setting intentions</li>
                    </ul>
                    <button class="btn beginner-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
          ...
          <div class="card beginner-card">
            <div class="card-body">
              ...
              <div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex w-100 justify-content-between">
                    <h6 class="mb-1"> Basics Workshop</h6>

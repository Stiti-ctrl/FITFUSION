          ...
          <div class="col-md-8">
            <div class="card border-0 shadow-sm">
              <div class="card-body p-4">
                ...
                <button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#feedbackModal">Submit Your Story</button>     
    ...
    <div class="modal-content">
      <form id="storyForm" novalidate>
        <div class="modal-header">
          <h5 class="modal-title" id="feedbackModalLabel">Share Your Story</h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="storyInput" rows="4" required></textarea>
            <div class="invalid-feedback">Please enter your story.</div>
          </div>
          <div id="successMsg" class="alert alert-success d-none">✅ Thank you! Your story has been submitted.</div>
        </div>
...
<!-- Bootstrap Bundle JS (must be included for modals to work) -->

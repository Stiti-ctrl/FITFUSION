      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="card mb-4 beginner-card">
            <div class="card-body">
              <h3 class="card-title mb-4">7 Days-physiothrapy Journey</h3>
              ...
              <div class="tab-content" id="dayTabsContent">
                ...
                <div class="tab-pane fade show active" id="monday" role="tabpanel">
                  ...
                  <div class="ratio ratio-16x9 mb-4">
                   <iframe width="914" height="514" src="https://www.youtube.com/embed/adoNwg8dgGc" title="How to clear phlegm from your chest | Active cycle of breathing technique (ACBT)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  </div>
                  <div class="class-details">
                    ...
                    <ul>
                      ...
                      <li><span class="intermediate-highlight">count and breathe</span> retrain your spine</li>
                      <li><span class="intermediate-highlight">gentle breathing exercises:</span> retrain your body</li>
                    </ul>
                ...
                <div class="tab-pane fade" id="tuesday" role="tabpanel">
                  ...
                  <p>Begin your journey with our experts.</p>
                  <div class="ratio ratio-16x9 mb-4">
                    <iframe width="914" height="514" src="https://www.youtube.com/embed/flTsYNqCxOw" title="How to retrain your breathing | Part 2 | Asthma, long covid or breathlessness" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  </div>
                  <div class="class-details">
                    <h5>Today's Practice</h5>
                    <ul>
            ...
            <div class="card-body">
              ...
              <div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  ...
                  <p class="mb-1">With dr.Ananya desai</p>
                </a>
              </div>
            </div>
          </div>

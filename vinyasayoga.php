...
// Set vinyasa Yoga specific parameters
...
<head>
  ...
  <style>
    /* vinyasa Yoga Specific Styles */
    .vinyasa-header {
      background: linear-gradient(135deg, #f8f9fa 0%, #e9f9f5 100%);
    }
    .vinyasa-tab .nav-link.active {
...
<body>
  ...
  <section class="class-header py-5 vinyasa-header">
    <div class="container">
  ...
  <section class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="card mb-4 vinyasa-card">
            <div class="card-body">
              <h3 class="card-title mb-4">7-Day vinyasa Journey</h3>
              ...
              <!-- Day Navigation -->
              <ul class="nav nav-tabs mb-4 vinyasa-tab" id="dayTabs" role="tablist">
              ...
              <div class="tab-content" id="dayTabsContent">
                ...
                <div class="tab-pane fade show active" id="monday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    ...
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Child's Pose:</strong> With bolster under torso and forehead supported</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Legs-Up-the-Wall:</strong> With hips elevated on folded blanket</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Reclining Bound Angle:</strong> Bolster under spine, blocks under knees</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Guided Relaxation:</strong> Body scan technique (10 minutes)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="tuesday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    <h5>Today's Practice <small class="text-muted">(Hold each pose 5-7 minutes)</small></h5>
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Pigeon Pose:</strong> With bolster under torso</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supine Figure-Four Stretch:</strong> With strap around foot</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Bridge Pose:</strong> Block under sacrum</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Breath Awareness:</strong> Counting breaths (10 minutes)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="wednesday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    <h5>Today's Practice <small class="text-muted">(Hold each pose 5-7 minutes)</small></h5>
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Fish Pose:</strong> Bolster lengthwise under spine</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Puppy Pose:</strong> With forehead resting on block</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Reclining Hero Pose:</strong> With back supported by bolster</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Loving-Kindness Meditation:</strong> (10 minutes)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="thursday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    <h5>Today's Practice <small class="text-muted">(Hold each pose 5-7 minutes)</small></h5>
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Seated Forward Fold:</strong> Bolster on legs</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Child's Pose Variation:</strong> With torso rotated</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Legs-Up-the-Wall Twist:</strong> With blanket between knees</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Body Scan Meditation:</strong> (10 minutes)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="friday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    ...
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Savasana:</strong> Bolster under knees, blanket under head</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Side-Lying Rest Pose:</strong> With pillow between knees</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Reclining Twist:</strong> With bolster between knees</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Yoga Nidra:</strong> Guided deep relaxation (15 minutes)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="saturday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    ...
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Supta Baddha Konasana:</strong> Bolster under spine, straps around thighs</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Elevated Legs-Up-the-Wall:</strong> With hips on bolster</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Side-Lying Pose:</strong> With blanket support</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Extended Yoga Nidra:</strong> (20 minutes)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="sunday" role="tabpanel">
                  ...
                  <div class="class-details p-4">
                    ...
                    <ul class="list-unstyled">
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Seated Meditation:</strong> On bolster or blanket (10 min)</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Gentle Neck Rolls:</strong> Seated with support (5 min)</li>
                      <li class="mb-3"><i class="fas fa-couch prop-icon"></i> <strong class="vinyasa-highlight">Supported Forward Fold:</strong> With bolster (7 min)</li>
                      <li><i class="fas fa-moon prop-icon"></i> <strong class="vinyasa-highlight">Closing Meditation:</strong> Gratitude practice (15 min)</li>
                    </ul>
                    <button class="btn vinyasa-btn mt-3">Mark as Completed</button>
                  </div>
                </div>
          ...
          <div class="card mb-4 vinyasa-card">
            <div class="card-body">
              <h5 class="card-title">Your vinyasa Journey</h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card mb-4 vinyasa-card">
            <div class="card-body">
              <h5 class="card-title">vinyasa Resources</h5>
              <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <span><i class="fas fa-file-pdf me-2 text-danger"></i> Prop Setup Guide</span>
                  <button class="btn btn-sm vinyasa-btn">Download</button>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <!-- Upcoming vinyasa Classes -->
          <div class="card vinyasa-card">
            <div class="card-body">
              <h5 class="card-title">Upcoming vinyasa Sessions</h5>
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex w-100 justify-content-between">
                    <h6 class="mb-1">Evening vinyasa</h6>
                ...
                <a href="#" class="list-group-item list-group-item-action">
                  <div class="d-flex w-100 justify-content-between">
                    <h6 class="mb-1">vinyasa & Reiki</h6>
          ...
          <!-- Prop Alternatives -->
          <div class="card mt-4 vinyasa-card">
            <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="input-group mb-3">
            ...
            <button class="btn vinyasa-btn" type="button" style="padding: 8px 20px;">Subscribe</button>
          </div>
        </div>
      </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      completeButtons.forEach(button => {
        button.addEventListener('click', function() {
          ...
          this.classList.remove('vinyasa-btn');
        });
      });
